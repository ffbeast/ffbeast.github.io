...
{: .important }
> All profiles there are in JSON format, and often browser treat it as normal document and opens in a new page. Use **"Right Click"** and **"Save As"** approach for downloading it.  
